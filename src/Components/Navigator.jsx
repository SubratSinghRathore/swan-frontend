...
export default function Navigator() {
  ...
  return (
    <>
      <div className='flex sm:hidden justify-evenly bg-blue-500 p-4 rounded-t-2xl fixed bottom-0 w-screen '>
        <NavLink to={"/"}>
          <svg viewBox="0 0 24 24" width="30" height="30" fill="currentColor" style={{ color: "white" }}>
        ...
        <NavLink to={"gallery"}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" color="white" fill="none">
